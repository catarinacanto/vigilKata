...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """game""", """controllers.HomeController.play"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """post""", """controllers.HomeController.post"""),
    Nil
  ...
  // @LINE:13
  private[this] lazy val controllers_HomeController_play2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("game")))
  )
  private[this] lazy val controllers_HomeController_play2_invoker = createInvoker(
    HomeController_1.play,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "play",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:13
    case controllers_HomeController_play2_route(params@_) =>
      call { 
        controllers_HomeController_play2_invoker.call(HomeController_1.play)
      }
  
    // @LINE:15
    case controllers_HomeController_post3_route(params@_) =>
      call { 
        controllers_HomeController_post3_invoker.call(HomeController_1.post)
      }
  }
}
